...
""" Simulacion 1 """
resultados.append(simulacionInteligente2(ModeloSIS, "Scale_Free", tam_grafo=tam, susceptibles=tam, time=100, beta=0.025, gamma=0.001))
...
""" Simulacion 2 """
resultados.append(simulacion(ModeloSIS, "Scale_Free", tam_grafo=tam, susceptibles=tam, time=100, beta=0.025, gamma=0.001))
